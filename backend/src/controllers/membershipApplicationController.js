...
// const User = require("../models/User");
// const bcrypt = require("bcryptjs");
// const nodemailer = require("nodemailer"); // FIXED LAYER: Load nodemailer engine for background notifications
// const { createAuditLog } = require("./auditLogController");
...
// |--------------------------------------------------------------------------
// | Securely pipes outbound messages through environment process credentials.
// | Automatically uses clean defaults if specific environment parameters are missing.
// */
...
//     // 1. Create entry in the demographic Member database ledger collection
//     const member = await Member.create({
//       ...memberData,
...
//     // 2. FIXED LAYER: Automatically create a login profile row inside your User collection
//     // This connects their application email as their exact secure username and login gateway link
//     await User.create({
//       username: assignedUsername,
//       email: targetEmail,
//       passwordHash: defaultPasswordHash,
...
//     // 3. NODEMAILER EXECUTION VECTOR: Transmit confirmation copy instantly to user inbox
//     try {
...
//             <p style="font-size: 13px; color: #64748b; margin-bottom: 0;">* Security Notice: For structural asset defense, navigate to profile settings screens to update this temporary password upon your first initialization boot loop.</p>
//           </div>
//         `
//       };
//       await transporter.sendMail(mailOptions);
//     } catch (mailError) {
//       // Soft fail log keeps main database transaction alive even if network mail connection times out
