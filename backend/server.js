...
// const Role = require("./src/models/Role"); // <-- FIXED LAYER: Import the Role model to prevent relational failures
...
// /*
// |--------------------------------------------------------------------------
// | SERVER START & AUTOMATIC DYNAMIC INITIALIZATION LAYER
// |--------------------------------------------------------------------------
// */
...
//   try {
//     // 1. FIXED LAYER: Check and auto-create the baseline SuperAdmin row record in your Role collection
...
//         role: "SuperAdmin",
//         roleId: superAdminRole._id // FIXED LAYER: Links the master user document row straight to the security role record
//       });
...
//     }
//   } catch (error) {
//     console.log("Could not auto-create admin account:", error.message);
//   }
// });
